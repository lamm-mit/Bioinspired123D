...
cell_core_phrases = {
    "cellular_generic": [
        ...
        "a cellular interconnected bioinspired material",
        "a cellular interconnected bioinspired cube",
        "a cellular interconnected bioinspired structure",
    ],
}
